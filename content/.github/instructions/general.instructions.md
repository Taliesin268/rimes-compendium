...
- **Session Notes:**  
  ...
  - Capture what happened, who was present, and what was learned, even if details are uncertain or incomplete.
  - Use bullet points or short paragraphs for in-session notes; use full sentences and narrative flow for formal recaps.
  - It’s acceptable to include personal uncertainty or speculation (e.g., “I think...”, “It seems...”).
  - Use first-person perspective for in-character notes (e.g., “I suggested...”, “We observed...”).

- **Recaps & Chronicles:**  
  - More stylized, in-world narrative voice (often from the perspective of Rime or another ego).
  - Use evocative language, metaphors, and emotional reflection.
  - Maintain continuity with previous entries and character perspectives.

- **Entity Pages (NPCs, Items, Locations, etc.):**  
  - Use the provided templates (see `Allies, NPCs, & Special Creatures/template.md`).
  - Start with a summary, then break down into sections: Description, Appearance, Abilities, Equipment, Relationships, etc.
...
- Use callouts for ego/character commentary (e.g., `> [!ryn] ...`).
...
- Always prefer updating existing entries over duplicating information.
- If a session note contains speculation or questions, consider adding “Unanswered Questions” or “To Investigate” sections to relevant pages.
- Use the “Unwritten Pages” system to track missing or stubbed entries.

---

These instructions should enable an AI Agent to maintain, update, and expand the compendium in a way that matches your established style and workflow.